...
M.config.functions.relative_number = function() 
  -- Autocomand to alternate relative number and show actual buffer
...
M.config.functions.cursorline_buffer = function ()
